<h2>🗃️ Apresentação do Desafio</h2>
Desenvolver a prática com as principais ferramentas do OO: ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO, 
através de um projeto Java.

Para representar a Orientação a Objetos este projeto utiliza de animais que podem ou não ser classificados 
como animais de estimação ou não. Assim as caracteristicas, ações e interação tenta utilizar das ferramentas 
citadas acima.

<h3></h3>
⚓ O conteúdo a seguir foi retirado de : https://github.com/cami-la/desafio-poo-dio
